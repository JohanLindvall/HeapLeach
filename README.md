...
mega, mediafire, ok.ru and the three streaming hosts are **resolved at
download time**, not when the link is queued — otherwise a large queue would start
failing halfway down.
